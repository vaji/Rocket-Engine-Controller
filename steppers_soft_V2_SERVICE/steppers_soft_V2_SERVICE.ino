...
const float CommandListPosX[] = {0, 0};
const float CommandListTimeX[] = {1, 2500};

const float CommandListPosY[] = {0, 30, 35, 35, 37, 37, 0};
const float CommandListTimeY[] = {1, 1500, 1500, 500, 1500, 500, 500};
// ************* DEFINE SEQUENCE HERE *******************

bool CommandListFlagX[] = {0,0};
